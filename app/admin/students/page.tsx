    ...
    <div>
      ...
      <div className="border border-border rounded-xl overflow-hidden">
        <table className="w-full text-body">
          <thead><tr className="text-caption text-text-secondary text-left border-b border-border"><th className="p-2.5">이름</th><th className="p-2.5">생년월일</th><th className="p-2.5">소속 반</th><th className="p-2.5">총 스티커</th><th className="p-2.5">연결 상태</th><th className="p-2.5">처리</th></tr></thead>
          <tbody>

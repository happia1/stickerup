...
export type Action =
  ...
  | { type: "ADD_CLASS"; name: string; specialStart: string | null; specialEnd: string | null; rankingUnit: RankingUnit }
  ...
  | { type: "ADD_REWARD_CAMPAIGN"; title: string; description: string; classId: string | null; periodStart: string; periodEnd: string; distributionType: "ratio" | "count"; distributionValue: number }
  ...
  | { type: "DELETE_REWARD_CAMPAIGN"; campaignId: string }

...
export function AppStoreProvider({ children }: { children: React.ReactNode }) {
  ...
  const dispatch = useCallback<React.Dispatch<Action>>((action) => {
    rawDispatch(action);
    const persistedActions = new Set(["ADD_CLASS", "UPDATE_CLASS_NAME", "UPDATE_CLASS_SPECIAL_PERIOD", "ADD_NOTICE", "UPDATE_NOTICE", "SET_NOTICE_PIN", "DELETE_NOTICE", "SET_RANKING_UNIT", "ADD_REWARD_CAMPAIGN", "DELETE_REWARD_CAMPAIGN", "ROLLBACK_LEDGER"]);

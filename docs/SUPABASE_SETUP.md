...
- The app accepts passwords of 4 characters or more. In the Supabase Dashboard, lower the project Auth password minimum length to `4` before enabling this in production. Supabase recommends a minimum of 8 characters, so use a stronger policy when service requirements allow it.
